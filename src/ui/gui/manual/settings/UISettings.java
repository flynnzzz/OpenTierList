package ui.gui.manual.settings;
...
public class UISettings {
	...
	public final static int DEFAULT_UNRANKED_PADDING_TOP = 40;
	...
	public final static int DEFAULT_TIER_PADDING_LEFT = 30;

	// ----- title -----//

	public final static int DEFAULT_TITLE_PADDING_TOP = 30;
	public final static int DEFAULT_TITLE_PADDING_RIGHT = 0;
	public final static int DEFAULT_TITLE_PADDING_BOTTOM = 10;
	public final static int DEFAULT_TITLE_PADDING_LEFT = 40;

	// ----- right buttons -----//

	public final static int DEFAULT_RBUTTON_PADDING = 15;
