...
public class StandardTierListControllerTest {
    ...
    public void setUp() {
        ...
        t3 = new Tier("t3"); t4 = new Tier("t4");

        tl.addTier(t1); tl.addTier(t2); tl.addTier(t3); tl.addTier(t4);
    ...
    public void tier() {
        ...
        controller.tier(el4, Tier.UNTIERED);
    ...
    public void moveTierPointer() {
        ...
        controller.moveTier(Tier.UNTIERED, t1);
