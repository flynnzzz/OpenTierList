...
public class GraphicsController {
    ...
    public void updateImages(FPElements pane) {
        ...
        List<TierElement> elements = pane.status() == TieredStatus.TIERED ?
                pane.getTier().getTiered() : tierListController.getUnTiered();
    ...
    public void addElement(ActionEvent ignoredEvent) {
        ...
        imageFileChooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Image Files", "*.png", "*.jpg", "*.jpeg", "*.gif"));
    ...
    public void saveTierList(ActionEvent ignoredEvent) {
        ...
        if (tierListController.saveTierList()) {
            GraphicsController.alert(
                    Alert.AlertType.INFORMATION, "Save successful", tierListController.getTierListName() + " was saved successfully"
            );
        }
        else {
            GraphicsController.alert(
                    Alert.AlertType.ERROR, "Save unsuccessful", tierListController.getTierListName() + " could not be saved successfully"
            );
        }
    }
    ...
    public void exportTierList(ActionEvent ignoredEvent) {
        if (tierListController.exportTierList(tieredPane)) {
            GraphicsController.alert(
                    Alert.AlertType.INFORMATION, "Export successful", tierListController.getTierListName() + " was exported successfully"
            );
        }
        else {
            GraphicsController.alert(
                    Alert.AlertType.ERROR, "Export unsuccessful", tierListController.getTierListName() + " could not be exported successfully"
            );
        }
    }
    ...
    public void setScrollPaneWidth(TieredStatus status, double width) { switch (status) {
